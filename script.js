document.addEventListener("DOMContentLoaded", () => {
    ...
    const WORDS = [
        'I love you', 'Tanmai', '❤', 'Tanmai', 'Budda', 'Tanmai',
        'Budda', 'Budda', 'Budda', 'me & you', 'love you', 'sweetheart'
    ];

    const secretMessage = "Happy Birthday, naa Bangaram ❤️🎂 You are my Tutti Frutti, beautiful story that began with our unforgettable bindi moments, those days when I could literally stare at you for 10 minutes and still feel like it wasn’t enough. 🥹❤️ Those little moments have become some of my favourite memories of us. Today, on your birthday, I’m making one little wish… that this story never ends here. I want us to keep choosing each other, growing together, building our little dreamy home, and one day looking back at these days with a smile. 🫶🏻From those bindi moments to growing old together… I want every chapter with you. ❤️✨ ❤️";
